...
from law_processed import get_law_graph_large
import keras.layers
...
batch_size = 128  #作者说OOM应该可以和small一样的……
max_epoch = 16
sent_len_fact = 100
doc_len_fact = 15
doc_len_law = 10
...
with tf.Graph().as_default():
    ...
    law_input, graph_list_1, graph_membership, neigh_index = get_law_graph_large(law_relation_threshold, 'w2id_thulac.pkl', 15, 100)
    ...
    decoder_1 = keras.layers.Dense(118)
    decoder_2 = keras.layers.Dense(130)
