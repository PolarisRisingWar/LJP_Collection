...
#标签数字到文本的对应见这个：
id2charge=open('new_accu.txt').readlines()

#然后CE文本是这两个：
CE1=open('CECP/data/CEs/CEs.txt',encoding='gbk').readlines()
CE2=open('CECP/data/CEs/CEs_supp.txt').readlines()
CE=CE1+CE2
...
to_path='/data/wanghuijuan/cecp_data/elements_cail_small.pkl'
